...
public class QuanLySach extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)), "Thông kê", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(102, 102, 102))); // NOI18N

        jLabelTongSachBan.setText("Tổng số đầu sách để bán :");

        jLabelTongSLSM.setText("Tổng số lượng sách mượn :");

        jLabelTongSLSB.setText("Tổng số lượng sách bán :");

        jLabelTongSach.setText("Tổng số đầu sách :");

        jLabelTongSLS.setText("Tổng số lượng sách :");
    ...
    public void thongKe() {
        ...
        jLabelTongSachMuon.setText("Tổng sách số đầu sách để mượn : " + tongSachMuon);
        jLabelTongSachBan.setText("Tổng sách số đầu sách để bán : " + tongSachBan);
        jLabelTongSLS.setText("Tổng số lượng sách :" + tongSoLuongSach);
        jLabelTongSLSM.setText("Tổng số lượng sách để mượn :" + tongSoLuongSachMuon);
        jLabelTongSLSB.setText("Tổng số lượng sách để bán :" + tongSoLuongSachBan);
    }
    private void jTableSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSachMouseClicked
        ...
        if (s.getMucDich() == 1) {
            jTextMucDich.setText("Sách mượn");
        } else {
            jTextMucDich.setText("Sách bán");
        }
            ...
            if (op == 0) {
                ...
                try {
                    ...
                    if (!IntegerValidate.isInteger(jTextSoLuong.getText())) {
                        throw new Exception("số lượng sai định dạng");
                    } else {
